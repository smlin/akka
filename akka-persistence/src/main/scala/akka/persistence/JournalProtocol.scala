...
private[persistence] object JournalProtocol {
   ...
   */
  case class WriteMessages(messages: immutable.Seq[Resequenceable], processor: ActorRef, actorInstanceId: Int)
   ...
   */
  case class LoopMessage(message: Any, processor: ActorRef, actorInstanceId: Int)
